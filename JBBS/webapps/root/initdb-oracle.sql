...
######
INSERT INTO bbscs_permission (ID, PermissionName, PermissionResource, Action, TypeID) VALUES  (430,'发布修改投票帖权限','/votePost','new,add,edit,editdo',2)
######
...
######
INSERT INTO bbscs_role (ID, RoleName, TypeID, Permissions) VALUES  (1,'版主角色',1,'401,402,403,404,405,406,407,408,409,410,411,412,413,414,420,421,422,423,424,425,426,427,430,431,432,433,434,435,440,450,451,460,462,463,464,465,466,470,471,475,601,602,603,604,605,606,607,608,609,610')
######
